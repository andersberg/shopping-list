...
describe("Grocery Input Parser", () => {
	...
	it("should parse item correctly when a potential modifier is part of the name", () => {
	...
	it("should parse item correctly when a potential modifier IS a modifier", () => {
	...
	it("should parse multi-word item correctly when potential multi-word modifier is NOT a modifier", () => {
	...
	it("should parse multi-word item correctly when potential multi-word modifier IS a modifier", () => {
